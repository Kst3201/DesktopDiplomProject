...
namespace DesktopDiplomProject.ServerASP.Features.ComponentManagement.Services.Motherboard
{
    public class MotherboardService : IComponentService<MotherboardDTO>
    {
        ...
        private NativeComponentNamedUnitService<MBSizeEntity> _sizeService;
        ...
        public async Task<MotherboardDTO> UpdateItem(MotherboardDTO dto)
        {
            try
            {
                var foundedItem = await GetByName(dto.Name);
            ...
            , IFuzzyService<double> fuzzyDoubleService, IDefuzzifyFunction function)
        {
            ...
            _context = context;
            _sizeService = new NativeComponentNamedUnitService<MBSizeEntity>(_context);
